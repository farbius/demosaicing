...
figure(1)
imshow(I);
title('Èñõîäíîå èçîáðàæåíèå')

figure(2)
imshow(IoutByte);
title('Âûõîä ôèëüòðà Áàéåðà')

figure(3)
imshow(lin_1st);
title('Ðàáîòà àëãîðèòìà â Matlab')

figure(4)
imshow(Iprocess);
title('Ðàáîòà àëãîðèòìà â RTL ìîäåëè')
display('processing done!');

% figure(5)
% imshow(lin_2nd);
% title('Ðàáîòà 2 - ãî àëãîðèòìà â Matlab')
